	...
	*/
	...
	jQuery.Elastislide.prototype = {
		...
		_addControls : function() {
			...
			this.$navigation = jQuery( '<nav><span class="elastislide-prev">Previous</span><span class="elastislide-next">Next</span></nav>' )
		...
		_slide : function( dir, tvalue ) {
			...
			if( this.support ) {
				...
				this.$el.stop().applyStyle( styleCSS, jQuery.extend( true, [], { duration : this.options.speed, complete : function() {
		...
		how to use:
		var carouselEl = jQuery( '#carousel' ),
		...
		if ( typeof options === 'string' ) {
			...
			this.each(function() {
				...
				if ( self ) {
					...
					self = jQuery.data( this, 'elastislide', new jQuery.Elastislide( options, this ) );
